    ...
    public static void validateIdentifier(String identifier){
        ...
        switch (typeIdentifier){
            case AP:
                ...
                if(identifier.substring(0, identifier.length() - 1).contains(lastChar)){
                    throw new BaseException(HttpStatus.BAD_REQUEST, "Idenficador invalido.");
                }
                break;
            case EU:
                ...
                if(Integer.parseInt(String.valueOf(identifier.charAt(0)) + Integer.parseInt(String.valueOf(identifier.charAt(7)))) == 9){
                    throw new BaseException(HttpStatus.BAD_REQUEST, "Idenficador invalido.");
                }
                break;
            case PF:
